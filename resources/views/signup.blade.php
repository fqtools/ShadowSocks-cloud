...
<div  ng-app ="app" class="container w-xxl w-auto-xs" ng-controller="SigninFormController" ng-init="app.settings.container = false;">
  ...
  <div class="m-b-lg">
    ...
    <p>
  <small class="text-muted">&copy;  2014 rumia.me</small>
</p>
  </div>
</div>t>
  @include('tree.bottom')
